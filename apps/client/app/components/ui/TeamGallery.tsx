      ...
      <div className="mt-20">
        <div className="flex w-full flex-col items-center justify-between md:flex-row">
          <InstaxImage
            ...
            alt="Two engineers collaborating on uptime dashboards"
            width={640}
            height={427}
            caption="At Uptiqué we obsess over reliability"
          />
          <InstaxImage
      ...
      <div className="mt-28">
        <div className="flex w-full flex-col items-center justify-between md:flex-row">
          <InstaxImage
            ...
            alt=" Join Uptiqué, be yourself."
            width={1819}
            height={998}
            caption=" Join Uptiqué, be yourself."
          />
        </div>
      </div>
    </section>
